...
import {attachPixel, onlyNumberString} from '../../module/formatter';
import Wrapper from './Wrapper';
import Text from './Text';
import theme from '../../../public/theme';
import {IUseInput} from 'src/hook/useInput';
import Img from './Img';
import { onlyNumber, onlyKorean, onlyNumberKorean, numberComma } from '../../module/formatter';
        ...
        <>
            ...
            >
                <_Input
                    ...
                    // onChangeText={props.hook!.setValue}
...
const InputWrapper = styled(Wrapper)<any>`
  ...
  height: ${({_height}: {_height: any}) => attachPixel(_height) || '50px'};
