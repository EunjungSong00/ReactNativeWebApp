...
const useLineWishEl = ({id, initialValue, type} : IWishEl, navigation:StackNavigationProp) => {
    const _id = Number(id)
        ...
        return(
            <TouchableOpacity onPress={() => setIsWish(prevState=>!prevState)}>
                <Wrapper>
                    <Img src={
                        isWish
                        ? require('../../../public/image/component/icon-line-wish-on.png')
                        : require('../../../public/image/component/icon-line-wish-off.png')}
                        width={type === 'small' ? 15 : 20 } height={ type === 'small' ? 15 : 20}
                    />
                </Wrapper>
            </TouchableOpacity>
        )
